...
namespace TestMakerFreeWebApp.Controllers
{
    public class AnswerController : BaseApiController
    {
        ...
        /// <summary>
        /// Edit the Answer sent in via the model
        /// </summary>
        ...
        public IActionResult Post([FromBody]AnswerViewModel model)
        {
            ...
            // return the updated question to the client.
            return new JsonResult(
                answer.Adapt<AnswerViewModel>(),
                new JsonSerializerSettings()
                {
        ...
        {
            var questions = DbContext.Answers.Where(a => a.QuestionId == questionId).ToArray();

            // output the result in JSON format
            return new JsonResult(
                questions.Adapt<AnswerViewModel[]>(),
                new JsonSerializerSettings()
                {
                    Formatting = Formatting.Indented
                });
